...
public class Main2 extends JFrame {
	...
	public Main2() {
		...
		btnEnd.setBounds(242, 53, 103, 27);
		...
		btnInquiry.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				txtMain.append("\t" + "uid" + "\t"+ "name" + "\t" + "hp" + "\t" + "age\n");

				for(User u : user) {
					txtMain.append("\t" + u.getUid() + "\t" + u.getName() + "\t" + u.getHp() + "\t" + u.getAge() + "\n");
				}
			}
		});
		btnInquiry.setFont(new Font("굴림", Font.BOLD, 16));
		btnInquiry.setBounds(12, 50, 103, 27);
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				txtMain.append("\t" + user.getUid() + "\t" + user.getName() + "\t" + user.getHp() 
				+ "\t" + user.getAge() + "\n");
				
				txtMain.append("\t검색 완료...");
			}
		});
		btnSearch.setFont(new Font("굴림", Font.BOLD, 16));
		btnSearch.setBounds(127, 92, 103, 27);
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				txtMain.append("삭제 완료...");
				
			}
		});
		btnDelete.setFont(new Font("굴림", Font.BOLD, 16));
		btnDelete.setBounds(12, 92, 103, 27);
		...
		txtSearch.setBounds(242, 92, 103, 27);
		contentPane.add(txtSearch);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(41, 170, 400, 299);
