 ...
 *  - 일반적으로 크게 산술, 복합대입, 비교, 논리 연산자를 사용
 */
public class OperatorTest {
	public static void main(String[] args) {
		...
		boolean rs4 = var1 <= var2; // var1은 var2보다 직거나 같다.
		boolean rs5 = var1 == var2; // var1은 var2와 서로 같다.
		boolean rs6 = var1 != var2; // var1은 var2와 서로 다르다.
		...
		boolean res3 = (var3 > 2) || (var4 > 3); // var3은 3보다 크고 또는 var4는 3보다 크다.
		boolean res4 = (var3 > 4) || (var4 > 5); // var3은 4보다 크고 또는 var4는 5보다 크다.
		boolean res5 = !(var3 > var4); // var3은 var4보다 크지않다.
